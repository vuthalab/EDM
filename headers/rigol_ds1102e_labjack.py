...
class RigolDS1102e(USBTMCDevice):
    ...
    def __init__(self):
        ...
        super().__init__(rigol_1102e_ADC, mode ='direct' )
    ...
    @property
    def trace2(self) -> Array:
         """Return the array of voltage readings for the currently active trace."""
         # Get raw trace bytes
         raw_data = self.query(f':WAV:DATA? CHAN{self.active_channel2}', raw=True, delay=0.05)
