...
topic = "CTC100_2"                        # Change this to whatever device you're going to use.
port = 5552                             # If port is in use, enter a different 4 digit port number.

delay_time = 0.5 #s, between measurements

# initialize device
thermometer = CTC100('/dev/ctc100_2')   # what the hell is the device address for the CTC controller?
...
counter = 0
channel_names = ['north hs','cell','45k plate','4k plate']
