...
#    'wavelength_range': 'custom',
    ...
    'front_filters': [ # (name, count, angle)
        ('SEMROCKTSP01-887-SP1', 1, 138.40),
        ('SEMROCKTSP01-887-SP2', 1, 69.00),
        #('FELH0800',1,0),
        #('FESH0900', 1, 0),
        # ('FES0800', 1, 0),
        #('SEMROCK842', 2, 0),
    ...
    'spectrometer_filters': [# (name, count, angle)
        ('FELH850_IN_BP2_MOUNT', 1, 19.00),
        ('FELH850_IN_BP3_MOUNT', 1, 19.00),
       #('SEMROCKTLP01-887-LP1', 1, 228.83),
       #('SEMROCKTLP01-887-LP2', 1, 223.33),
       # ('SEMROCK842FF01', 1, 0),
       # ('SEMROCK842FF01', 1, 0),
    ],
